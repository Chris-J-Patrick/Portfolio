        ...
        {selectedProject && (
          ...
          >
            <motion.div
              ...
              exit={{ x: "100%" }}
              transition={{ duration: 0.3 }}
              className="relative bg-gray-700 rounded-lg shadow-lg overflow-y-auto py-6 w-full max-w-full h-full mx-auto my-0 p-2"
                ...
                <div className="lg:w-full ">
                  ...
                  {selectedProject.demoLink ? (
                    <iframe
                      ...
                      title="Live Demo"
                      className="w-full h-[60vh] sm:h-[80vh] md:h-[90vh] rounded-lg shadow-lg"
                      frameBorder="0"
                    ></iframe>
                  ) : (
                    <div className="text-center max-w-full bg-gray-800 p-8 rounded-lg shadow-lg">
                      <Swiper
